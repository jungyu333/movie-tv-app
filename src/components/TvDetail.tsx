...
const SubCover = styled.div<{ bgphoto: string }>`
  position: relative;
  width: 100%;
  height: 20vmax;
...
function TvDetail() {
  ...
  const { data } = useQuery<IgetTvDetail>(["Tv", "Detail"], () =>
    ...
    <>
      <>
        {videoData?.results.length !== 0 ? (
          ...
          <SubCover
            bgphoto={makeImagePath(String(data?.backdrop_path), "w500")}
          ></SubCover>
        )}
      </>
